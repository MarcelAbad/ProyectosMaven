...
public class FormController {
    ...
    private void mostrarAlertPassword(){
        ...
        alert.setTitle("Error de la validacion");
        alert.setHeaderText("Contraseña no valida");
        alert.setContentText("La contraseña debe tener mínimo 6 caracteres y al menos un numero");
    ...
    private void mostrarAlertConfirm(){
        ...
        alert.setHeaderText("¿Desea iniciar sesión?");
